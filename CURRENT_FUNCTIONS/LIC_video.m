...
if setup.pipeline.lic_video
    ...
    for i = setup.instantaneous.runs
        ...
        for imNo = 1:setup.imProperties.imageCount
            ...
            set(gca, 'YDir', 'reverse', 'FontSize', setup.figures.axisFontSize, ...
